...
//  Pushcart
//
//  Created by Letícia Gonçalves on 6/16/15.
...
extension AppDelegate: CLLocationManagerDelegate {
    ...
    func locationManager(manager: CLLocationManager!,
        ...
        inRegion region: CLBeaconRegion!) {
            let viewController:FirstViewController = window!.rootViewController as! FirstViewController
